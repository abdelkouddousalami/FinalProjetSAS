...
int signinAsAgent() {
    char username[20], password[20];
    printf("veuillez entrer Agent username : ");
    gets(username);
    printf("veuillez entrer Agent mot de pass : ");
    gets(password);

    if (strcmp(username, "agent") == 0 && strcmp(password, "Agent@3214") == 0) {
        printf("connexion agent reussie\n");
        return 1;
    } else {
        return 0;
    }
